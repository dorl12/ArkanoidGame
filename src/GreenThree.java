...
/**
 * The main class for GreenThree.
 * This is a program that defines the third level of the game.
 *
 * @author Dor Levy
 */
public class GreenThree implements LevelInformation {
    ...
    public static final int MAX_NUM_OF_REC_IN_ROW = 10;
    private static final int WIDTH_OF_BLOCK = 50;
    private static final int HEIGHT_OF_BLOCK = 20;

    /**
     * This method is a constructor of the GreenThree class.
    ...
    public List<Velocity> initialBallVelocities() {
        ...
        ballsVelocitiesList.add(Velocity.fromAngleAndSpeed(330, 8));
        ballsVelocitiesList.add(Velocity.fromAngleAndSpeed(30, 8));
    ...
    public List<Block> blocks() {
        ...
        for (int i = 0; i < NUM_OF_ROWS; i++) {
            for (int j = MAX_NUM_OF_REC_IN_ROW - i; j > 0; j--) {
                Block block =
